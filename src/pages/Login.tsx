        ...
        <div className="h-screen flex items-center justify-center bg-black">
            ...
            >
                ...
                <form onSubmit={handleLogin} className="space-y-5">
                    ...
                    <div className="flex items-center justify-between">
                        <label className="flex items-center gap-2 cursor-pointer">
                            <input
                                ...
                                className="w-4 h-4 rounded border-white/10 bg-black/50 text-white focus:ring-white/30"
                            />
                    ...
                    {error && (
                        <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="flex items-center gap-2 text-red-400 text-sm bg-red-500/10 p-3 rounded-lg">
                            <ShieldAlert size={16} /> {error}
                        </motion.div>
                    )}

                    <button type="submit" className="w-full bg-white text-black font-bold py-4 rounded-xl flex items-center justify-center gap-2 hover:bg-gray-200 transition-colors mt-6">
                        Access Terminal <ArrowRight size={18} />
                    </button>
                </form>
                <p className="text-center text-gray-600 text-xs mt-8">Restricted to Authorized Personnel Only</p>
            </motion.div>
        </div>
    );
};
