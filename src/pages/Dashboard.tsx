...
export const Dashboard = () => {
    const { isDataLoading, leads, properties, team, user, addLead, tradingRevenue, saasRevenue, updateTradingRevenue, updateSaasRevenue } = useStore();
        ...
        <motion.div variants={container} initial="hidden" animate="show" className="space-y-4 md:space-y-6 p-4 md:p-10 pt-4 md:pt-8 h-screen w-full max-w-full overflow-y-auto overflow-x-hidden scrollbar-hide">
            ...
            {isDataLoading ? (
                <div className="w-full h-[60vh] flex flex-col items-center justify-center space-y-4">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 font-medium animate-pulse">Loading dashboard intelligence...</p>
                </div>
            ) : (
                <>
                    ...
                    {/* PIPELINE VISUALIZATION — Recharts BarChart Funnel */}
